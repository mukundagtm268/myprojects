...
Force Tags   vdev_write  vdev_write_err_inj_tc09
...
Post-stap Check Expected Pool And Drives State
    ...
    ...  checkstr=injected write error 1 times
    NAS: Utils: Check error raid disks existence  ${diskid}  count=${1}
    ...  timeout=${300}
